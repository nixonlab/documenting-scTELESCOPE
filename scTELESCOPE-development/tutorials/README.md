...
Now, Git is really helpful to work as a team in coding projects because many people can work simultaneously on the same things. We can use something like GitHub, which is an internet service that hosts git repositories, to keep our projects and work on them together.
